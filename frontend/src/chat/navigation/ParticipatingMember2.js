            ...
            <Grid className={"borderRight500"}>
                    ...
                    <List>
                        ...
                        */}
                        ...
                        .map(participants => 
                            <ListItem button key={participants.no}>
                                <ListItemIcon>
                                    <Avatar alt={participants.chatNickname} src={participants.chatNickname} />
                                </ListItemIcon>
                                <ListItemText primary={participants.chatNickname}>{participants.chatNickname}</ListItemText>
                                {/* <ListItemText secondary="online" align="right"></ListItemText> */}
                                <ListItemText align="right"/> <ParticipantsStatus style={{fontSize:'12px', color: '#34d12c'}}/>
                            </ListItem>
                            )
                        }
                    </List>
